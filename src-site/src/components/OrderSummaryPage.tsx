...
// import { TMX_BUCKET_URL } from "../utils/constants";
...
//           target="_blank"
//           rel="noreferrer"
//           className="bg-pink-600 text-white px-12 py-2 rounded hover:bg-pink-700 transition-colors font-mono"
//         >
//           TMX
//         </a>
//         <a
//           href={`https://www.google.com?q=${sessionId}`}
//           target="_blank"
//           rel="noreferrer"
//           className="bg-pink-600 text-white px-12 py-2 rounded hover:bg-pink-700 transition-colors font-mono"
//         >
